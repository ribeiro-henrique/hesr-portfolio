export default function HeroSection() {
    ...
    return (
        <section className="position-relative z-1 min-vh-100 d-flex flex-column align-items-center justify-content-center text-center gap-2">
            ...
            <div className="d-flex gap-3 flex-wrap justify-content-center mb-3">
                <a href="#" className="btn-outline">✉ Me Contacte</a>
                <a href="#" className="btn-accent">Baixe meu Currículo ↓</a>
            </div>
